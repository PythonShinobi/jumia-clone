...
const Home = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await axios.get(`https://jumia-clone-backend.vercel.app/products`);
              ...
              {products.map((product) => (
                <Carousel.Item key={product.id}>
                  <img
                    ...
                    src={`https://jumia-clone-backend.vercel.app/uploads/${product.image}`}
                    alt={product.name}
...
const CategorySection = ({ category }) => {
  ...
  useEffect(() => {
    const fetchCategoryProducts = async () => {
      try {
        const response = await axios.get(`https://jumia-clone-backend.vercel.app/products/category/${category}`);
