          ...
          <Grid item xs={12} sm={6} md={4}>
            <Card>
              <CardMedia
                ...
                alt="Hoodies"
                height="300"
                image={`${config.backendURL}/uploads/image-1718700238.jpeg`}
                title="Hoodies"
              />
              <CardContent>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Card>
              <CardMedia
                ...
                alt="Light Lamps"
                height="300"
                image={`${config.backendURL}/uploads/image-1718697211.jpeg`}
                title="Light Lamps"
              />
              <CardContent>
                <Typography variant="h5" component="div">
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Card>
              <CardMedia
                ...
                alt="Accessories"
                height="300"
                image={`${config.backendURL}/uploads/image-1718699719.jpeg`}
                title="Accessories"
              />
              <CardContent>
                <Typography variant="h5" component="div">
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Card>
              <CardMedia
                ...
                alt="Shoes"
                height="300"
                image={`${config.backendURL}/uploads/image-1718864281.jpeg`}
                title="Shoes"
              />
              <CardContent>
                <Typography variant="h5" component="div">
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Card>
              <CardMedia
                ...
                alt="Shoes"
                height="300"
                image={`${config.backendURL}/uploads/image-1718865948.jpeg`}
                title="Shoes"
              />
              <CardContent>
                <Typography variant="h5" component="div">
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Card>
              <CardMedia
                ...
                alt="Shoes"
                height="300"
                image={`${config.backendURL}/uploads/image-1718867958.jpeg`}
                title="Shoes"
              />
              <CardContent>
                <Typography variant="h5" component="div">
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} sm={6} md={4}>
            <Paper elevation={3} style={{ padding: '20px', textAlign: 'center' }}>
              <Avatar alt="Team Member" src={`${config.backendURL}/uploads/alice-brown.jpg`} style={{ margin: 'auto', width: '100px', height: '100px' }} />
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Paper elevation={3} style={{ padding: '20px', textAlign: 'center' }}>
              <Avatar alt="Team Member" src={`${config.backendURL}/uploads/david-green.jpg`} style={{ margin: 'auto', width: '100px', height: '100px' }} />
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Paper elevation={3} style={{ padding: '20px', textAlign: 'center' }}>
              <Avatar alt="Team Member" src={`${config.backendURL}/uploads/emma-white.jpeg`} style={{ margin: 'auto', width: '100px', height: '100px' }} />
